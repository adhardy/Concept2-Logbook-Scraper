...
def get_profile(profile):
    #check the cache again to make sure it's not been added since the thread was queued
    ...
    if profile.profile_id in profile.profile_cache.keys():
        ...
        print("Cache hit: " + profile.profile_type + ": " + profile.profile_id)
    else:
        print("Thread " + profile.profile_id + ": Getting profile: " + profile.url)
                    ...
                    if row_tree != []:
                        ...
                        if get_profile_data == True and profile_ID != None:
                            ...
                            if profile_ID in athletes_cache.keys():
                                athletes[profile_ID] = athletes_cache[profile_ID]
                            else:
                        ...
                        if get_extended_workout_data == True:
                            if workout_ID in ext_workouts_cache.keys():
                                athletes[profile_ID] = ext_workouts_cache[profile_ID]
                            else:
